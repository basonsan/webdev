  ...
  <div class="container main main_reviews s-main__main">
    ...
    <div class="main__content">
      <ul class="bread-crumbs main__bread-crumbs">
        ...
        <li class="bread-crumbs__item">
          <a href="/results/" class="bread-crumbs__link text-link">
            Они смогли
          </a>
        </li>
        <li class="bread-crumbs__item">
    ...
    <div class="row section__content">
      <div class="col-lg-8 col-12 section__content-left">
        <div class="text-content text-descr_fz-16">
          <!-- gallery -->
          <div class="swiper-container item-items item-items_slider item-items_gallery js-swiper-gallery" style="margin-bottom:40px">
            <!-- swiper slider -->
