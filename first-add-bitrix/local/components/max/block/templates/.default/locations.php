            ...
            <div class="col-lg-6 col-12 order-lg-first locations__gallery js-tabs-content">
                ...
                <? foreach($data['ELEMENTS'] as $key3 => $item):?>
                    ...
                    <div class="locations__gallery-item js-tabs-content-item <?= ($key3 == '0') ? 'js-active' :'' ?>">
                        <!-- locations gallery -->
                        <div class="swiper-container2 locations__gallery-gallery locations-gallery js-swiper-locations-gallery">
                            <!-- swiper slider -->
                            <div class="swiper-wrapper2 locations-gallery__swiper">
                                <? foreach($item['IMG'] as $img): ?>
                                    <!-- swiper slide -->
                                    <div class="swiper-slide2 locations-gallery__item">
